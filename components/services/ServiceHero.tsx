  ...
  return (
    <section className="relative flex min-h-[75vh] items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          We help you plan the look, organise the decorative details, and set
          up your venue with the right balance of beauty, flow, and budget.
        </motion.p>
      </div>
    </section>
  );
