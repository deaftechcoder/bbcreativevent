  ...
  return (
    <section className="relative flex min-h-[70vh] items-center overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/assets/images/gallery banner.png"
          alt="BB Creative Events Gallery"
          fill
          priority
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          Explore our event decoration portfolio, from luxury weddings and
          birthdays to elegant corporate events and unforgettable celebrations.
        </motion.p>
      </div>
    </section>
  );
